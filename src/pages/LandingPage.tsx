    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container relative min-h-[90vh] flex flex-col items-center justify-center px-4 py-32 text-center text-white z-10">
            <div className="max-w-5xl mx-auto">
              <div className="inline-block mb-3 px-4 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 animate-fade-in">
              ...
              <h1 className="mb-6 text-5xl font-bold tracking-tight sm:text-6xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80 drop-shadow-sm animate-fade-in">
                Master Professional Skills Through AI Simulation
              </h1>
              
              <p className="mb-8 max-w-2xl mx-auto text-xl sm:text-2xl text-white/90 animate-fade-in delay-100">
                Practice and perfect your workplace skills with realistic AI colleagues in simulated environments
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-in delay-200">
                <Link to="/auth/signup">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto animate-fade-in delay-300">
        ...
        <section id="features" className="py-24 bg-muted/30">
          <div className="container px-4">
            <div className="text-center mb-16">
              <div className="inline-block mb-3 px-4 py-1 rounded-full bg-primary/10 animate-fade-in">
                <span className="text-sm font-medium text-primary flex items-center gap-1">
                  <Sparkles className="h-4 w-4" />
                  Platform Highlights
                </span>
              </div>
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4 animate-fade-in delay-100">
        ...
        <section id="how-it-works" className="py-24 bg-gradient-to-br from-background to-muted/50">
          <div className="container px-4">
            <div className="text-center mb-16">
              <div className="inline-block mb-3 px-4 py-1 rounded-full bg-secondary/50 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 relative">
              ...
              <div className="relative z-10 flex flex-col items-center text-center bg-card p-8 rounded-xl shadow-lg border border-border scroll-slide-in hover:shadow-xl transition-all duration-300">
                ...
                <div className="mt-4 flex items-center justify-center">
                  <ChevronRight className="h-6 w-6 text-skill-blue animate-pulse" />
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center bg-card p-8 rounded-xl shadow-lg border border-border scroll-slide-in hover:shadow-xl transition-all duration-300">
                ...
                <div className="mt-4 flex items-center justify-center">
                  <ChevronRight className="h-6 w-6 text-skill-purple animate-pulse" />
                </div>
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center bg-card p-8 rounded-xl shadow-lg border border-border scroll-slide-in hover:shadow-xl transition-all duration-300">
                ...
                <div className="mt-4 flex items-center justify-center">
                  <Check className="h-6 w-6 text-skill-deepPurple animate-pulse" />
                </div>
              </div>
            </div>
        ...
        <section id="testimonials" className="py-24 bg-gradient-to-br from-muted/30 to-background">
          <div className="container px-4">
            <div className="text-center mb-16">
              <div className="inline-block mb-3 px-4 py-1 rounded-full bg-accent/10 animate-fade-in">
